...
runBtn.addEventListener('click', async () => {
  ...
  runBtn.disabled = true; runBtn.querySelector('.run-label').textContent = 'Running\u2026';
...
function renderScoreSection() {
  ...
  overallScore.textContent = overall + '%'; overallScore.style.color = color;
  overallGrade.textContent = grade; overallGrade.style.color = color; overallGrade.style.background = gradeColor;
